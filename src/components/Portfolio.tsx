  ...
  const sampleProjects = [
    {
      ...
      description:
        "A adorable family of penguins made with soft cotton yarn. Each penguin has its own personality with different colored scarves and expressions.",
      techniques: [
        "Single crochet",
        "Increasing",
        "Decreasing",
      ...
      yarn_details:
        "Cotton DK weight in black, white, orange, and various colors for accessories",
    ...
    },
    {
      ...
      description:
        "A vibrant throw blanket made from 64 granny squares in rainbow colors. Perfect for adding a pop of color to any room.",
    ...
    },
    {
      ...
      description:
        "A functional and adorable tote bag featuring a cat face design. Sturdy enough for everyday use with reinforced handles.",
    ...
    },
    {
      ...
      description:
        "A warm and cozy scarf perfect for winter weather. Features a simple but elegant stitch pattern.",
    ...
    },
    {
      ...
      description:
        "A detailed dragon with moveable wings and intricate scale texture. One of my most challenging projects!",
      techniques: [
        "Single crochet",
        "Increasing",
        "Decreasing",
    ...
    },
    {
      ...
      description:
        "A set of 6 colorful dishcloths for the kitchen. Practical and pretty!",
    ...
    },
    {
      ...
      thumbnail:
        "https://images.pexels.com/photos/6474569/pexels-photo-7188004.jpeg?auto=compress&cs=tinysrgb&w=400",
      difficulty: "Intermediate",
      time_spent: "3 hours",
      completed_date: "September 2023",
      description:
        "Adorable baby booties with ribbon ties. Made as a gift for a friend's new baby.",
    ...
    },
    {
      ...
      description:
        "A delicate lace doily with complex stitch patterns. Required careful attention to detail and precise tension control.",
  ...
  const filteredProjects =
    activeDifficulty === "all"
      ...
      : sortedProjects.filter(
          (project) => project.difficulty === activeDifficulty
        );
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-amber-700 max-w-2xl mx-auto">
              A collection of my handmade creations, each crafted with love and
              attention to detail
            </p>
          </div>
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
            ...
            {filteredProjects.length === 0 && (
              <div className="text-center py-20">
                <p className="text-amber-700 text-lg">
                  No projects found at this difficulty level.
                </p>
              </div>
            )}
          </div>
        ...
        {/* Modal - Updated to show full images */}
        {selectedProject && (
                      ...
                      {selectedProject.images.length > 1 && (
                        <>
                          <button
                            ...
                            className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full disabled:opacity-30 hover:bg-opacity-70 transition-all duration-200"
                          >
                          ...
                          <button
                            ...
                            className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-2 rounded-full disabled:opacity-30 hover:bg-opacity-70 transition-all duration-200"
                          >
                        ...
                        {selectedProject.images.map(
                          (image: string, index: number) => (
                            <button
                              ...
                              className={`flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 bg-gray-50 ${
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedProject.techniques.map(
